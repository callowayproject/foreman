...
For detailed configuration options, see [config.example.yaml](config.example.yaml) and the [Project Specification](specs/initial/SPEC.md).
...
Contributions are welcome! Whether it's adding a new agent, improving the harness, or fixing bugs, please see [CONTRIBUTING.md](CONTRIBUTING.md) for our development guidelines.

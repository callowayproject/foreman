...
if TYPE_CHECKING:
    from night_brownie.config import AgentAssignment, NightBrownieConfig
...
class RouteTarget:
    ...
    Attributes:
        ...
        agent_assignment: The matching `night_brownie.config.AgentAssignment`
...
class Router:
    ...
    def __init__(self, config: NightBrownieConfig) -> None:
        self._config = config
